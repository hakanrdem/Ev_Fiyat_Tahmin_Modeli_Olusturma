...
df = pd.read_csv("dsmlbc_9_abdulkadir/Homeworks/hakan_erdem/6_Makine_Ogrenmesi_YapayOgrenme/Maaş Tahmin Modeli Oluşturma/houseprice_train.csv")
...
RMSE: 0.126 (GBM) 
RMSE: 0.1227 (XGBoost) 
RMSE: 0.1309 (LightGBM)

"""

# Sonuçlara dayanarak hiperparametre optimizasyonlarını gerçekleştiriniz.
...
# Modelin test ediniz ve 22222'nin altına düşmeye çalışınız
